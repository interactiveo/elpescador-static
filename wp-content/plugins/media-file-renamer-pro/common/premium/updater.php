...
class MeowCommonPro_Updater {
  ...
  */
  private function get_update_transient_data() {
    ...
    $limited_data->requires = isset( $version_info->requires ) ? $version_info->requires : null;
    $limited_data->requires_php = isset( $version_info->requires_php ) ? $version_info->requires_php : null;
